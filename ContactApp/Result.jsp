...
<body>
    ...
    <div class="content" id="formContent">
        <form action="ContactApp" method="post">
            ...
            <input type="text" name="name" placeholder="Enter Name" value ="First name">
            <h2>Enter The Contact Number</h2>
            <input type="text" name="contactNumber" placeholder="Enter Contact Number" value ="Contact number" required>
            <br><br>
    ...
    <form action="Search" method="get">
        <input class="search-icon" type="text" name="number"  placeholder="&#x1F50D;"> 
