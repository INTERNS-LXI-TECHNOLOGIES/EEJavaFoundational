...
public class Forest
{
	...
	public void cellCreation()
	{
		...
		for (int i = 0;i<10;i++)
		{
			...
			for(int j = 0; j<10;j++)
			{
				cell[i][j] = new Cell("/hunger-game/images/one.jpg");
	...
	public void createFood()
	{
		...
		for (int i =0;i<10;i++)
		{
			Food f1 = new Food("Apple","/hunger-game/images/app.jpg",-15);
		...
		for(int j =0;j<10;j++)
		{
			Food f2 = new Food("Orange","/hunger-game/images/orange.jpg",-10);
		...
		for(int k =0;k<10;k++)
		{
			...
			Food f3 = new Food("Meet","/hunger-game/images/meet.jpg",-12);
	...
	public void createHunter()
	{
		...
		for(int  i = 0;i < 10; i++)
		{
			Hunter h1 = new Hunter("hunter","/hunger-game/images/hunter1.jpg",10);
			int a = (int) (Math.random()*10);
			int b = (int) (Math.random()*10);
		...
		for (int j = 0;j <10;j++)
		{
			Hunter h2 = new Hunter("hunter","/hunger-game/images/hunter2.jpg",10);
			int c = (int) (Math.random()*10);
			int d = (int) (Math.random()*10);
