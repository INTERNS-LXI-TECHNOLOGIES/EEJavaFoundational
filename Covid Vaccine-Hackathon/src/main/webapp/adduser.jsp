...
<body>
     <%if(request.isUserInRole("User")){%>
	    <div id="login">
        <h3 class="text-center text-white pt-5">Add User</h3>
        <div class="container">
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="AddServlet" method="get">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="age" id="age" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="number" class="text-info">Enter the Address</label><br>
                                <input type="name" name="address" id="address" class="form-control">
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="name" name="blood" id="blood" class="form-control">
                            </div>
                            <div class="form-group">
