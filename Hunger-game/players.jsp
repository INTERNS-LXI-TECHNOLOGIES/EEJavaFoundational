<%@ page import = "com.lxisoft.hungergame.model.Player" %>
<%@ page import = "com.lxisoft.hungergame.model.Forest" %>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
    ...
    Player player = new Player(name,"/hunger-game/images/player"+f.getGamers().size()+".jpg");
   ...
   // f.setTotalPlayers(f.getGamers().size());
    if (!f.getGamers().isEmpty()) {
        for(Player p : f.getGamers())
        {
         %>
         <li>
        <img src="<%= p.getPlayerIcon() %>" alt = "PlayerIcon">
        <%= p.getName() %>
        </li>
    <% }
    }
