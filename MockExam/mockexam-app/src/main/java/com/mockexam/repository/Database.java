...
public class Database
{
	...
	public void createTable()
	{
		try
		{
			String sql ="create table mockexamdb(id int not null auto_increment,question varchar(30) not null,opt1 varchar(30) not null,opt2 varchar(30) not null,opt3 varchar(30) not null,opt4 varchar(30) not null,answer varchar(25) not null,attempted boolean not null,mark int not null,primary key(id))";
			stmt = con.createStatement();
			stmt.executeUpdate(sql);
		}
		catch(SQLException e)
