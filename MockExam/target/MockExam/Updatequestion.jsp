...
<form>
  ...
  <input type="text" id="question" name="question" value="<%out.println(models.get(i).getQuestion());%>"><br>
  <label for="option1">Option1 : </label>
  <input type="text" id="option1" name="option1" value="<%out.println(models.get(i).getOpt1());%>" ><br>
  <label for="option2">Option2 : </label>
  <input type="text" id="option2" name="option2" value= "<%out.println(models.get(i).getOpt2());%>"><br>
  <label for="option3">Option3 : </label>
  <input type="text" id="option3" name="option3" value= "<%out.println(models.get(i).getOpt3());%>"><br>
  <label for="option4">Option4 : </label>
  <input type="text" id="option4" name="option4" value= "<%out.println(models.get(i).getOpt4());%>"><br>
  <label for="answer">Answer : </label>
  <input type="text" id="answer" name="answer" value= "<%out.println(models.get(i).getAnswer());%>"><br></h3>
