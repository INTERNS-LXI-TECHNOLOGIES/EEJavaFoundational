...
<body>
    <div class="container">
        ...
        <form action="/workshop/productValidator" method="post">
            ...
            <div class="form-group">
                ...
                <c:forEach var="err" items="${validationErrors}">
                    <c:if test="${err == 'Product Brand is invalid.'}">
                <span class="error">${err}</span>
            </c:if>
                </c:forEach>
            </div>
            ...
            <div class="form-group">
                ...
                <c:forEach var="err" items="${validationErrors}">
                    <c:if test="${err == 'Product Manufacturer is invalid.'}">
                <span class="error">${err}</span>
            </c:if>
                </c:forEach>
            </div>
            <div class="form-group">
                ...
                <input type="text" id="productReleaseDate" name="productReleaseDate" required>
                <c:forEach var="err" items="${validationErrors}">
                    <c:if test="${err == 'Product Date is invalid.'}">
                <span class="error">${err}</span>
            </c:if>
                </c:forEach>
            </div>
            <div class="form-group">
                ...
                <input type="text" id="productAvailability" name="productAvailability" required>
                <c:forEach var="err" items="${validationErrors}">
                    <c:if test="${err == 'Product Available is invalid.'}">
                <span class="error">${err}</span>
            </c:if>
                </c:forEach>
            </div>
