    ...
    <div class="container">
        <c:choose>
            ...
            <c:otherwise>
                <form action="admin" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="input-container">
                        <i class="fas fa-user"></i>
                        <input type="text" name="name" placeholder="<c:out value="${language['enterUserName']}"/>">
                    </div>
                    <div class="input-container">
                        <i class="fas fa-lock"></i>
                        <input type="password" name="password" placeholder="<c:out value="${language['uploadYourImage']}"/>">
                    </div>
                    <div class="input-container">
                        <i class="fas fa-phone"></i>
        ...
        <div class="language-switch">
            ...
            <div class="language-options" id="languageOptions">
                <a href="locale?lang=ml">Malayalam</a>
