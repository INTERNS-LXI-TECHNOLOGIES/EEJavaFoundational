...
<body>
    <%if(request.isUserInRole("user")){%>
	    <div id="login">
        <h3 class="text-center text-white pt-5">UPDATE USER</h3>
        <div class="container">
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="UpdateServlet" method="get">
                            ...
                            <div class="form-group">
                                <label for="number" class="text-info">Enter the AGE</label><br>
                                <input type="name" name="lname" id="lname" class="form-control"value="<%= request.getParameter("temp1")%>">
                            </div>
                             <div class="form-group">
                                <label for="number" class="text-info">Enter the Address</label><br>
                                <input type="name" name="lname" id="lname" class="form-control"value="<%= request.getParameter("temp2")%>">
                            </div>
                             <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="number" class="text-info">Enter the Blood Group</label><br>
                                <input type="name" name="lname" id="lname" class="form-control"value="<%= request.getParameter("temp4")%>">
                            </div>
                            <div class="form-group">
