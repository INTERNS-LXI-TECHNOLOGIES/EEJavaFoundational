...
<head>
	<link rel="stylesheet" type="text/css" href="jsp\styles.css"><CENTER><font color="red" size="32"><b> CONTACT APP </b></font></CENTER></head>
<body>
<%@ page import="com.lxisoft.Domain.*" %>
<%@ page import="com.lxisoft.Models.*" %>
<%@ page import="java.util.*" %>

<a href="jsp/addnew.jsp?newcontact=true"><button >+</button></a>
</button> 
 <center>
