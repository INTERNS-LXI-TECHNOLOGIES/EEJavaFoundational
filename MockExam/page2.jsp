      ...
      ArrayList<Model> model=new ArrayList<Model>();
       ...
       if(qcount != model.size()) {
        ...
        <h1><input type="radio" name="opt" value="1"/>
          <label for="opt1"><font color="midnightblue"><% out.println(model.get(qcount).getOpt1());%></label></font></h1>
          <h1><input type="radio" name="opt" value="2"/>
          <label for="opt2"><font color="midnightblue"><% out.println(model.get(qcount).getOpt2());%></label></font></h1>
          <h1><input type="radio" name="opt" value="3"/>
          <label for="opt3"><font color="midnightblue"><% out.println(model.get(qcount).getOpt3());%></label></font></h1>
          <h1><input type="radio" name="opt" value="3"/>
          <label for="opt4"><font color="midnightblue"><% out.println(model.get(qcount).getOpt4());%></label></font></h1>
