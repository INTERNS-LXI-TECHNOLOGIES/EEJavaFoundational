...
if(qcount != model.size()) 
{
	...
	<div align = "center">
		<button align = "center" class="button" type="submit">NEXT</button> <button align = "center" class="button" type="submit" value=<%out.println(qcount);%>>SKIP</button>
	</div>
	</form>
<%} 
else 
