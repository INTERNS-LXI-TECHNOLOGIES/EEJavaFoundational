...
<form>
  ...
  <input type="text" id="addressAmr" name="addressAmr"><br><br>
  <label for="phone">Phone Number =</label>
  <input type="text" id="phnoAmr" name="phnoAmr"><br><br>
  <label for="vehiclenumber">Vehicle number =</label>
  <input type="text" id="vehicleNoAmr" name="vehicleNoAmr"><br><br>
  <label for="vehicleType">Vehicle Type =</label>
  <input type="text" id="vehicleTypeAmr" name="vehicleTypeAmr"><br><br>
  ...
  <input type="text" id="coPassengerAmr" name="coPassengerAmr"><br><br>
  <label for="relation">Relation With you =</label>
  <input type="text" id="relationAmr" name="relationAmr"><br><br>
